...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        std::tuple("1.0010", "1.9", V::Operator::GT),
        std::tuple("1.05", "1.5", V::Operator::EQ),
        std::tuple("1.0", "1", V::Operator::GT),
        std::tuple("2.50", "2.5", V::Operator::GT),
        std::tuple("fc4", "fc.4", V::Operator::EQ),
        std::tuple("FC5", "fc4", V::Operator::LT),
        std::tuple("2a", "2.0", V::Operator::LT),
        std::tuple("1.0", "1.fc4", V::Operator::GT),
        std::tuple("3.0.0_fc", "3.0.0.fc", V::Operator::EQ),
        // from RPM tests
        std::tuple("1.0", "1.0", V::Operator::EQ),
        std::tuple("1.0", "2.0", V::Operator::LT),
        std::tuple("2.0", "1.0", V::Operator::GT),
        std::tuple("2.0.1", "2.0.1", V::Operator::EQ),
        std::tuple("2.0", "2.0.1", V::Operator::LT),
        std::tuple("2.0.1", "2.0", V::Operator::GT),
        ...
        std::tuple("xyz.4", "xyz.4", V::Operator::EQ),
        std::tuple("xyz.4", "8", V::Operator::LT),
        std::tuple("8", "xyz.4", V::Operator::GT),
        std::tuple("xyz.4", "2", V::Operator::LT),
        std::tuple("2", "xyz.4", V::Operator::GT),
        std::tuple("5.5p2", "5.6p1", V::Operator::LT),
        ...
        std::tuple("6.0", "6.0.rc1", V::Operator::LT),
        std::tuple("10b2", "10a1", V::Operator::GT),
        std::tuple("10a2", "10b2", V::Operator::LT),
        std::tuple("1.0aa", "1.0aa", V::Operator::EQ),
        std::tuple("1.0a", "1.0aa", V::Operator::LT),
        std::tuple("1.0aa", "1.0a", V::Operator::GT),
        ...
        std::tuple("2_0", "2_0", V::Operator::EQ),
        std::tuple("2.0", "2_0", V::Operator::EQ),
        ...
        std::tuple("1.0.0", "2.0.0", V::Operator::LT),
        std::tuple(".0.0", "2.0.0", V::Operator::LT),
        std::tuple("alpha", "beta", V::Operator::LT),
        std::tuple("1.0", "1.0.0", V::Operator::LT),
        std::tuple("2.456", "2.1000", V::Operator::LT),
        std::tuple("2.1000", "3.111", V::Operator::LT),
        std::tuple("2.001", "2.1", V::Operator::EQ),
        std::tuple("2.34", "2.34", V::Operator::EQ),
        std::tuple("6.1.2", "6.3.8", V::Operator::LT),
