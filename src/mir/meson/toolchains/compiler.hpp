...
class Compiler {
  public:
    ...
    /**
     * get the depfile generation arguments
     *
     * @param target_file the file being generated by the target (such as an object file)
     * @param dep_file the dependency file being written
     */
    virtual std::vector<std::string> generate_depfile(const std::string & target_file,
                                                      const std::string & depfile) const = 0;
